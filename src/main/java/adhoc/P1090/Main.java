...
public class Main {
	...
	static int UM_QUADRADO = 114, DOIS_QUADRADOS = 115, TRES_QUADRADOS = 116,
						...
						UM_TRIANGULO = 117, DOIS_TRIANGULOS = 118, TRES_TRIANUGLOS = 119;
	...
	static int[][] validSets = new int[][]{
		...
		{TRES_TRIANUGLOS, UM_QUADRADO, DOIS_CIRCULOS},
		{TRES_TRIANUGLOS, DOIS_QUADRADOS, UM_CIRCULO},

		{UM_QUADRADO, DOIS_QUADRADOS, TRES_QUADRADOS},
		{UM_CIRCULO, DOIS_CIRCULOS, TRES_CIRCULOS},
		{UM_TRIANGULO, DOIS_TRIANGULOS, TRES_TRIANUGLOS},
		...
		{TRES_TRIANUGLOS, TRES_TRIANUGLOS, TRES_TRIANUGLOS},
